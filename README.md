...
| 2 | Data Types & Expressions | [Slides](slide/w2.pdf) | [Lab](notebooks/w1.ipynb) | [Session 1](https://youtu.be/2pj4_SbwybY), [Session 2](#)  | `int` / `float` / `str`, arithmetic, precedence, type conversion, f-strings | Ch. 2 | Dr. I.S. Ahmad |
