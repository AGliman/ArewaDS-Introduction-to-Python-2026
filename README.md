...
| 3 | Making Decisions | [Slides](slide/w3.pdf) | [Lab](notebooks/w3-2.ipynb) | [Session 1](https://youtu.be/rw3Fr13EJMw), [Session 2](https://youtu.be/OicPd57ZsOE) | Booleans, comparison & logical operators, `if` / `elif` / `else` | Ch. 3 (selection) | [Dr. I.S. Ahmad](https://isahmadbbr.github.io) |
